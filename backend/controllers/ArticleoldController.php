...
/**
 * ArticleoldController implements the CRUD actions for Article model.
 */
class ArticleoldController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams, Article::TYPE_NEWS_OLD);
    ...
    public function actionCreate()
    {
        ...
        $model->news = Article::TYPE_NEWS_OLD;
