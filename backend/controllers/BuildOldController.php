...
class BuildOldController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function actionIndex()
    {
        ...
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams, BuildHouse::RESOURCE_OLD);
    ...
    public function actionCreate()
    {
        ...
        if ( $model->load(Yii::$app->request->post()) && $modelContent->load(Yii::$app->request->post()) ) {
            $model->resource = BuildHouse::RESOURCE_OLD;
