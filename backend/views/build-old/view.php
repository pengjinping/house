...
<div class="build-house-view  wrapper wrapper-content animated fadeInRigh">
    ...
    <table style="text-align:left" class="table table-bordered">
        ...
        <tr><td>小区名称</td><td><?= Html::encode($model->village); ?></td></tr>
        <tr><td>类型</td><td><?= Html::encode(BuildHouse::$TYPE_MAP[$model->type]);?></td></tr>
        <tr><td>均价</td><td><?= Html::encode($model->price); ?> /平米</td></tr>
        <tr><td>总价</td><td><?= Html::encode($model->total); ?> 万</td></tr>
        <tr><td>面积</td><td><?= Html::encode($model->size); ?> 平米</td></tr>
        <tr><td>标记</td><td><?php
            foreach (explode(',', $model->flag) as $flag){
                echo '<span class="btn btn-primary">'. $flag. '</span> ';
            } ?></td></tr>
